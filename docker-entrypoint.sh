...
export DATABASE_HOST="confluence-cluster-671-db"
export DATABASE_USER="confluence"
export DATABASE_PASS="confluence"
export DATABASE_DB="confluence"
export LB_NAME="confluence-cluster-671-lb"
export LB_PORT="50671"
...
export SYNCHRONY_URL="http://confluence-cluster-671-lb:50671/synchrony"
...
echo -e "CATALINA_OPTS=\"-Dsynchrony.service.url=http://confluence-cluster-671-lb:50671/synchrony/v1 \${CATALINA_OPTS}\"\n" >> /confluence/atlassian-confluence-latest/bin/setenv.sh
...
then
  ...
  curl --connect-timeout 180 --max-time 180 --fail -o /tmp/confluence-home.tar  http://confluence-cluster-671-node1:8888/download
